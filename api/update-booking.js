// Vercel Serverless Function - PATCH /api/update-booking
// Updates a booking in the master calendar
...
export default async (req, res) => {
    ...
    try {
        const { eventId, patch, sendUpdates, userEmail } = req.method === 'PATCH' ? req.body : req.body;
        ...
        if (!eventId || !patch) {
            return res.status(400).json({ success: false, error: 'Event ID and patch required' });
        }
